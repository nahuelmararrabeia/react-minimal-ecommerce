...
Product listing with search, category and sorting

Product detail page

Cart drawer with persistence (Zustand + localStorage)

Checkout UI and order success flow (demo)
...
Shopify / WooCommerce frontends

Custom online stores

Marketing-driven product sites
...
https://react-minimal-ecommerce.vercel.app
